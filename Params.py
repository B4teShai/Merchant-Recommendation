# -*- coding: utf-8 -*-
"""Model and training parameters via argparse."""
...
def parse_args():
    ...
    parser.add_argument("--reg", default=1e-2, type=float, help="L2 reg weight lambda2 (paper: 1e-2)")
    ...
    parser.add_argument(
        ...
        type=int,
        default=64,
        help="number of query vector's dimension [default: 64]",
    )
    parser.add_argument(
        "--num_attention_heads",
        type=int,
        default=16,
        help="number of num attention heads [default: 16]",
    )
    ...
    parser.add_argument(
        ...
        default=0,
        type=int,
        help="number of deep layers to make the final prediction",
    )
